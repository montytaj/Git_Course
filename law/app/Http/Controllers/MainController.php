...
class MainController extends Controller
{
    ...
    protected function saveImage($photo,$folder,$counter){
       ...
       // $myimage = $photo->getClientOriginalName();
       // $photo->move(public_path($folder), $myimage);
    ...
    public function notifications() {
        ...
        $Notifications = Notification::where([['Status','=','1'],['NotificationDate','>=',$CurrentDate]])->get();
        return view('public.notifications',compact('Notifications'));
    }//END public function notifications()
    ...
    }//END public function add_notification(Request $request)
   
   public function show_notification($ShowID) {
       $CurrentDate = date('Y-m-d');
       $Notification = Notification::where([['NotificationID','=',$ShowID],['Status','=','1']])->first();
       $Notifications = Notification::where([['Status','=','1'],['NotificationDate','>=',$CurrentDate]])->get();
       return view('public.notifications',compact('Notification','Notifications'));
   }//END public function show_notification($ShowID)
   ...
   public function update_notification(Request $request) {
        ...
        $UpdateQuery = DB::table('notifications')->where('NotificationID', $UpdateID)
        ->update([
            'Notification' =>$request->Notification,
            'NotificationDate' =>$request->NotificationDate,
            'UUserID'=>$UserData->UserID,
    ...
    }//END public function update_notification(Request $request)
    ...
    public function delete_notification(Request $request) {
        ...
        $UpdateID = $request->UpdateID;
        $AccountID = $request->AccountID;
        $DeleteQuery = DB::table('notifications')->where('NotificationID', $UpdateID)
        ->update([
            'Status' =>-1,
            'DUserID'=>$UserData->UserID,
            'DDate' =>$CurrentDateTime
    ...
    }//END public function delete_notification(Request $request)
