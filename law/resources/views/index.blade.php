						...
						<div class="modal-body" style="min-height: 600px;">
							...
							<form method="post" name="LawyerForm" id="LawyerForm" onsubmit="return validation('LawyerForm');" enctype="multipart/form-data">
								...
								<div class="row">
									...
									<div class="col-md-4">
										<div class="Icon-inside">
											<input type="number" class="registration-input" name="LawyerAccountID" id="LawyerAccountID" placeholder="رقم الحساب   الآيبان" >
				...
				<div class="row g-4">
					...
					@foreach($Services as $Service)
						@php
							...
							//$ShowServiceDetails = substr($ServiceDetails,0,250);
							$ServiceImg = $Service->ServiceImage;
							if(empty($ServiceImg) or $Counter ==1) {
								$ServiceImg = 'public/assets/img/5.jpg';
							}//END if(empty($ServiceImg) or $Counter ==1)
							
							if($Counter == 1) {

							//var_dump($ServiceImg);
							//var_dump($Service->ServiceID);
						@endphp
							...
							<div class="col-md-3 ">
								<div class="card service_card"> 
									<div class="card-header">
										<center>
											<img src="{{asset($ServiceImg)}}" width="100%" height="180px" class="card-img-top img-circle" alt="...">
											<button id="Update" class="btn btn-secondary button" style="width:70%; margin:0 auto;margin-top: -170px; border-radius: 12px; background-color: /*transparent;*/white; opacity: 0.70;max-height: ; border-color:#06BBCC; border-width: 2px;  color: gray;"> خدمة جديدة  </button>
										</center>
									</div>
									<div class="card-body" style="padding: 1rem 0rem;">
										...
										<center><div style="max-height: 160px;min-height: 160px; padding: 10px 20px 10px 20px;text-align: justify;  font-size: 18px;"> خدمة تستطيع من خلالها وصف الخدمة التي ترغب في طلبها مهما كان نوع الخدمة القانونية . </div></center>
									</div>
									...
									<div class="card-footer" style="border-top: 0px;">
										<center>
											<a href="customers/custome_order/0" target="_blank" class="btn btn-primary " style="width:60%; margin:0 auto;margin-top: -17px; border-radius: 25px; background-color: #06BBCC;max-height: ; border-width: 2px;  color: white" onclick="return chek_session(0);">
											طلب الخدمة 
											</a>
										</center>
									</div>
						...
						<div class="card service_card"> 
							...
							<div class="card-body" style="padding: 1rem 0rem;">
								...
								<center><div style="max-height: 160px;min-height: 160px; padding: 15px 20px 10px 20px;text-align: justify; font-size: 16px;">{{$ServiceDetails}} </div></center>
							</div>
							<form id="OrderForm" name="OrderForm">
								@csrf
								<input type="hidden" name="CustomerID" id="CustomerID" value="{{$CustomerID}}">
							...
							<div class="card-footer" style="border-top: 0px;">
								<center>
									<a href="customers/custome_order/{{$Service->ServiceID}}" target="_blank" class="btn btn-primary " style="width:60%; margin:0 auto;margin-top: -17px; border-radius: 25px; background-color: #06BBCC;max-height: ; border-width: 2px;  color: white" onclick="return chek_session({{$Service->ServiceID}});">
									طلب الخدمة 
									</a>
								</center>
							</div>
