            ...
            <table id="myTable" class="table table-striped" style="width:100%" align="center">
                <thead>
                    <tr>
                        ...
                        <td align="center" width="7%"><b> العروض    </b></td>
                    </tr>
                </thead>
                <tbody>
                    @php
                    ...
                    @foreach($Orders as $Order)
                        ...
                        <tr>
                            ...
                            <td align="center"><a href="{{route('show_offer',$Order->CustomOrderID)}}" role="button"  class="btn btn-primary button"  value="" style="margin-right: 2px; margin-left: 2px; margin-top: 2px; margin-bottom: 2px;"> عرض </a></td>
                        </tr>
                    @endforeach
                </tbody>  
            </table>
